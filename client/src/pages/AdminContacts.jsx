...
export const AdminContacts = () => {
    ...
    const getAllUsersData = async () => {
        try {
            const response = await fetch("https://mern-admin-0miv.onrender.com/api/admin/contacts", {
                method: "GET",
                headers: {
    ...
    const deleteUser = async (id) => {
        try {
            const response = await fetch(`https://mern-admin-0miv.onrender.com/api/admin/contacts/delete/${id}`, {
                method: "DELETE",
                headers: {
                    Authorization: authorizationToken,
                }
