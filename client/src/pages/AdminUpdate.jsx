...
const AdminUpdate = () => {
    ...
    const getSingleUserData = async () => {
        try {
            const response = await fetch(`https://mern-admin-0miv.onrender.com/api/admin/users/${params.id}`, {
                method: "GET",
                headers: {
    ...
    const handleUpdate = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch(`https://mern-admin-0miv.onrender.com/api/admin/users/update/${params.id}`, 
              {
                method: "PATCH",
                headers: {
